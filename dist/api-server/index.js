...
var startServer = function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        app = express_1.default().use(compression_1.default());
        apolloServer = graphql_1.default();
        ...
        app.listen({ port: config_1.PORT }, function () {
            return console.log("\uD83D\uDE80 API server ready at http://localhost:" + config_1.PORT + apolloServer.graphqlPath);
        });
        return [2 /*return*/];
    });
}); };
